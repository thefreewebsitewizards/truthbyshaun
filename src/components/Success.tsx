      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="max-w-md mx-auto text-center p-8">
          <div className="bg-red-50 p-4 rounded-lg mb-6">
            <FiHelpCircle className="text-red-500 text-3xl mx-auto mb-2" />
        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="bg-blue-50 rounded-lg p-8 mb-8">
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">
              <FiClock className="inline text-blue-500 mr-2" />
              What's Next?
            </h2>
            <div className="text-left space-y-4 text-gray-700">
              <div className="flex items-start">
                <FiMail className="text-blue-500 mr-3 mt-1 flex-shrink-0" />
                <p>You'll receive a confirmation email shortly with your order details.</p>
              </div>
              <div className="flex items-start">
                <FiPhone className="text-blue-500 mr-3 mt-1 flex-shrink-0" />
                <p>Shaun will contact you within 24 hours to schedule your session or provide access to your plan.</p>
              </div>
              <div className="flex items-start">
                <FiHelpCircle className="text-blue-500 mr-3 mt-1 flex-shrink-0" />
                <p>
